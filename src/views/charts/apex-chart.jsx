      ...
      <Row>
        ...
        <Col lg={6}>
          <Card>
            ...
            <Card.Body className="pt-2 pb-3">
              <Chart options={lineAreaChartOptions} series={lineAreaChartOptions.series} type="area" height={350} />
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col lg={6}>
          <Card>
            ...
            <Card.Body className="pt-2 pb-3">
              <div>
                <Chart options={columnChartOptions} series={columnChartOptions.series} type="bar" height={350} />
              </div>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col lg={6}>
          <Card>
            ...
            <Card.Body className="pt-2 pb-3">
              <div>
                <Chart options={barChartOptions} series={barChartOptions.series} type="line" height={350} />
              </div>
            </Card.Body>
          </Card>
        </Col>
