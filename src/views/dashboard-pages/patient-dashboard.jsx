                  ...
                  <div className="col-md-6">
                    <div className="progress-round patient-progress mx-auto" data-value="80">
                      <span className="progress-left">
                        <span className="progress-bar border-secondary" style={{ transform: 'rotate(108deg)' }}></span>
                      </span>
                      <span className="progress-right">
                        <span className="progress-bar border-secondary" style={{ transform: 'rotate(180deg)' }}></span>
                      </span>
                          ...
                          <Col md={4} key={index}>
                            <div className="training-block d-flex align-items-center mb-md-0 mb-4">
                              <div className="rounded-circle card-icon bg-primary-subtle">
                                <img
                                  src={generatePath(`/assets/images/page-img/${training.imgSrc}`)}
                                  className="img-fluid filter-img-dark"
                                  alt="icon"
                                />
                              </div>
                              <div className="ms-3">
                      ...
                      <div className="card-header-toolbar d-flex align-items-center mb-3 patient-dash">
                        <Dropdown>
                          <Dropdown.Toggle
                            ...
                            className="bg-primary-subtle btn"
                            style={{ fontSize: '22px' }}
                          >
