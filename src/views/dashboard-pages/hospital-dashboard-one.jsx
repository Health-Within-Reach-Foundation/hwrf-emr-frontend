                ...
                <Card.Body>
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="text-end">
                      <h2 className="mb-0 text-primary counter">
                        {' '}
                        <CountUp start={0} end={5600} duration={3} separator="" />
                      </h2>
                ...
                <Card.Body>
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="rounded-circle card-icon bg-warning">
                      <i className="ri-women-fill text-white"></i>
                    </div>
                    <div className="text-end">
                      <h2 className="mb-0 text-warning">
                        <CountUp start={0} end={3450} duration={3} separator="" />
                      </h2>
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="text-end">
                      <h2 className="mb-0 text-danger">
                        <CountUp start={0} end={3500} duration={3} separator="" />
                      </h2>
