                  ...
                  <tbody>
                    {records.map((record, index) => (
                      <tr key={record.country}>
                        <td>
                          <img src={generatePath(record.flag)} className="img-fluid" alt={`${record.country} flag`} />{' '}
                          {record.country}
                        </td>
                ...
                <Card className="card-block card-stretch card-height mb-0">
                  <Card.Body>
                    ...
                    <h5 className="contact-number">
                      <i aria-hidden="true" className="ion ion-android-call"></i> + 1 800 324 2323
                    </h5>
