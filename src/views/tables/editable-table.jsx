            ...
            <Card.Body>
              <div id="table" className="table-editable ">
                <span className="table-add float-end mb-3 me-2">
                  <button className="btn btn-sm btn-success-subtle">
                    <i className="ri-add-fill" onClick={addNewValue}>
                        ...
                        <tr key={props} dataid={adds.id}>
                          ...
                          <td>
                            <span className="table-up">
                              <a href="#!" className="indigo-text" onClick={() => moveRowUp(props)}>
                                <i className="fa fa-long-arrow-up" aria-hidden="true"></i>
                              </a>
                            </span>{' '}
                            <span className="table-down">
                              <a href="#!" className="indigo-text" onClick={() => moveRowDown(props)}>
