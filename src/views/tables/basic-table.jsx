      ...
      <Row>
        <Col sm={12} lg={6}>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                <code className="highlighter-rouge">&lt;thead&gt;</code>s appear light or dark gray.
              </p>
              <table className="table">
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                Add <code className="highlighter-rouge">.table-sm</code> to make tables more compact by cutting cell padding
                in half.
              </p>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                A <code className="highlighter-rouge">&lt;caption&gt;</code> functions like a heading for a table. It helps
        ...
        <Col sm={12} lg={6}>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                Use <code className="highlighter-rouge">.table-striped</code> to add zebra-striping to any table row within
                the <code className="highlighter-rouge">&lt;tbody&gt;</code>.
              </p>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                Add <code className="highlighter-rouge">.table-hover</code> to enable a hover state on table rows within a{' '}
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                viewports by wrapping a <code className="highlighter-rouge">.table</code> with{' '}
                <code className="highlighter-rouge">.table-responsive</code>. Or, pick a maximum breakpoint with which to
                have a responsive table up to by using{' '}
                <code className="highlighter-rouge">.table-responsive{'{-sm|-md|-lg|-xl|-xxl}'}</code>.
              </p>
