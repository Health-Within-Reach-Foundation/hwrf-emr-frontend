          ...
          <Col sm="12">
            <Card>
              ...
              <Card.Body>
                ...
                <div className="table-responsive custom-table-search">
                  <table ref={tableRef} className="table dataTable" data-toggle="data-table"></table>{' '}
                </div>
              </Card.Body>
            </Card>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <div className="table-responsive">
                  <div className="mb-3">
                    Toggle column:{' '}
                    <Link className="toggle-vis btn btn-outline-primary mb-1" data-column="0">
                      Name
                    </Link>{' '}
                    -{' '}
                    <Link className="toggle-vis btn btn-outline-primary mb-1" data-column="1">
                      Position
                    </Link>{' '}
                    -{' '}
                    <Link className="toggle-vis btn btn-outline-primary mb-1" data-column="2">
                      Office
                    </Link>{' '}
                    -{' '}
                    <Link className="toggle-vis btn btn-outline-primary mb-1" data-column="3">
                      Age
                    </Link>{' '}
                    -{' '}
                    <Link className="toggle-vis btn btn-outline-primary mb-1" data-column="4">
                      Start date
                    </Link>{' '}
                    -{' '}
                    <Link className="toggle-vis btn btn-outline-primary mb-1" data-column="5">
                      Salary
                    </Link>
                  </div>

                  <table ref={columnTableRef} className="table dataTable" data-toggle="data-table"></table>
                </div>
              </Card.Body>
            </Card>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <div className="table-responsive">
                  {/* datatable  */}
                  <table ref={inputTableRef} className="table dataTable my-3" data-toggle="data-table"></table>
                </div>
              </Card.Body>
            </Card>
              ...
              <Card.Body>
                ...
                <div className="table-responsive">
                  <select id="langSelector" className="form-control mb-3">
                    <option id="english" value="eng" data-path="../../assets/vendor/language/english.json">
                      English
                    </option>
                    <option id="german" value="german" data-path="../../assets/vendor/language/german.json">
                      German
                    </option>
                    <option id="french" value="french" data-path="../../assets/vendor/language/french.json">
                      French
                    </option>
                    <option id="hindi" value="hindi" data-path="../../assets/vendor/language/hindi.json">
                      Hindi
                    </option>
                    <option id="japanase" value="japanase" data-path="../../assets/vendor/language/japanese.json">
                      Japanese
                    </option>
                  </select>
                  <table ref={langTableRef} className="table dataTable" data-toggle="data-table"></table>
                </div>
              </Card.Body>
            </Card>
          </Col>
