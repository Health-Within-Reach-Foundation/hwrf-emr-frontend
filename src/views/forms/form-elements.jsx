      ...
      <Row>
        <Col sm={12} lg={6}>
          <Card>
            ...
            <Card.Body>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vulputate, ex ac venenatis mollis, diam nibh
                finibus leo
              </p>
              <Form className="cust-form-elements">
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="pwd" className="mb-0">
                    Password:
                  </Form.Label>
                ...
                <Form.Group className="form-group custom-control custom-checkbox mb-3">
                  ...
                  <Form.Check.Label className="custom-control-label" htmlFor="basicformCheck">
                    Remember me
                  </Form.Check.Label>
                </Form.Group>
                <button type="submit" className="btn btn-danger-subtle mt-2">
                  Cancel
                </button>{' '}
                <button type="submit" className="btn btn-primary-subtle me-1 mt-2">
                  Submit
                </button>
              </Form>
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Form className="cust-form-elements">
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleInputText1" className="mb-0">
                    Input Text{' '}
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleInputEmail3" className="mb-0">
                    Email Input
                  </Form.Label>
                  <Form.Control
                    type="email"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleInputurl" className="mb-0">
                    Url Input
                  </Form.Label>
                  <Form.Control
                    type="url"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleInputphone" className="mb-0">
                    Telephone Input
                  </Form.Label>
                  <Form.Control
                    type="tel"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleInputNumber1" className="mb-0">
                    Number Input
                  </Form.Label>
                  <Form.Control type="number" className="form-control my-2" id="exampleInputNumber1" defaultValue="2356" />
                </Form.Group>
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleInputPassword3" className="mb-0">
                    Password Input
                  </Form.Label>
                  <Form.Control
                    type="password"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="exampleFormControlTextarea1" className="mb-0">
                    Example textarea
                  </Form.Label>
                  <Form.Control
                    as="textarea"
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Form className="cust-form-elements">
                <Form.Group className="form-group">
                  <Form.Label htmlFor="colFormLabelSm" className="mb-0">
                    Small
                  </Form.Label>
                  <Form.Control
                    type="email"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="colFormLabel" className="mb-0">
                    Default
                  </Form.Label>
                  <Form.Control
                    type="email"
                ...
                <Form.Group className="mb-0 form-group">
                  <Form.Label htmlFor="colFormLabelLg" className="pb-0 mb-0">
                    Large
                  </Form.Label>
                  <Form.Control
                    type="email"
            ...
            <Card.Body>
              ...
              <Form className="form-horizontal cust-form-elements">
                <Row className="form-group align-items-center">
                  <Col sm={2}>
                    <Form.Label className="control-label align-self-center mb-0" htmlFor="email">
                      Email:
                    </Form.Label>
                  </Col>
                  <Col sm={10}>
                ...
                <Row className="form-group align-items-center">
                  <Col sm={2}>
                    <Form.Label className="control-label align-self-center mb-0" htmlFor="pwd1">
                      Password:
                    </Form.Label>
                  </Col>
                  <Col sm={10}>
                ...
                <Form.Group className="form-group">
                  <div className="custom-control custom-checkbox">
                    ...
                    <Form.Check.Label className="custom-control-label" htmlFor="horizontalformCheck">
                      Remember me
                    </Form.Check.Label>
                  </div>
                </Form.Group>
            ...
            <Card.Body>
              ...
              <Form.Group className="form-group">
                ...
                <Form.Check className="d-block">
                  ...
                  <Form.Check.Label htmlFor="flexCheckdedchecked11">Checked checkbox</Form.Check.Label>
                </Form.Check>
                <Form.Check className="d-block">
              ...
              <Form.Group className="form-group">
                ...
                <Form.Group className="form-group">
                  <Form.Check className="d-block">
                    ...
                    <Form.Check.Label htmlFor="flexCheckDefault2">Default checkbox</Form.Check.Label>
                  </Form.Check>
                  <Form.Check className="d-block">
                    <Form.Check.Input type="checkbox" defaultValue="" id="checkedcheck" defaultChecked />
                    <Form.Check.Label htmlFor="checkedcheck">Checked checkbox</Form.Check.Label>
                  </Form.Check>
                  <Form.Check className="d-block">
                    <Form.Check.Input type="checkbox" defaultValue="" id="flexCheckDisabled1" disabled />
                    <Form.Check.Label htmlFor="flexCheckDisabled1">Disabled checkbox</Form.Check.Label>
                  </Form.Check>
                  <Form.Check className="d-block">
                    <Form.Check.Input
                      type="checkbox"
                      defaultValue=""
                      id="flexCheckcheckedDisabled11"
                      disabled
                      defaultChecked
                    />
                    <Form.Check.Label htmlFor="flexCheckcheckedDisabled11">Disabled checked checkbox</Form.Check.Label>
                  </Form.Check>
                </Form.Group>
                <Form.Check className="custom-control custom-radio custom-control-inline">
                  <Form.Check.Input
                    ...
                    defaultChecked
                  />
                  <Form.Check.Label className="custom-control-label" htmlFor="customRadio8">
                    {' '}
                    Selected radio
                  </Form.Check.Label>
                </Form.Check>
                <Form.Check className="custom-control custom-radio custom-control-inline">
                  <Form.Check.Input
                    ...
                    disabled
                  />
                  <Form.Check.Label className="custom-control-label" htmlFor="customRadio9">
                    {' '}
                    disabled radio
                  </Form.Check.Label>
                </Form.Check>
                <Form.Check className="custom-control custom-radio custom-control-inline">
                  <Form.Check.Input
                    ...
                    defaultChecked
                  />
                  <Form.Check.Label className="custom-control-label" htmlFor="customRadio10">
                    {' '}
              ...
              <Form.Group className="form-group">
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="customFile1" className=" custom-file-input">
                    Choose File
                  </Form.Label>
              ...
              <Form.Group className="form-group cust-form-elements">
                <Form.Label htmlFor="customFile" className=" custom-file-input">
                  Example File Input
                </Form.Label>
                <Form.Control className="form-control" type="file" id="customFile" />
              </Form.Group>
              <Form.Group className="form-group cust-form-elements">
                <Form.Label htmlFor="customFile2" className=" custom-file-input">
                  Choose File
                </Form.Label>
                <Form.Control className="form-control" type="file" id="customFile2" />
              </Form.Group>
              <button type="submit" className="btn btn-danger-subtle">
                Cancel
              </button>{' '}
