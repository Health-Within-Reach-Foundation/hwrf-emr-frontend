          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Form.Group className="radio d-inline-block me-2 form-group">
                ...
                <Form.Check.Label className="opacity-100" htmlFor="radio1">
                  Active
                </Form.Check.Label>
              </Form.Group>{' '}
              <Form.Group className="radio d-inline-block me-2 form-group">
                <Form.Check.Input type="radio" name="bsradio" className="form-check-input" id="radio2" />{' '}
                <Form.Check.Label className="opacity-100" htmlFor="radio2">
                  Inactive
                </Form.Check.Label>
              </Form.Group>{' '}
              <Form.Group className="radio d-inline-block me-2 form-group">
                <Form.Check.Input
                  ...
                  defaultChecked
                />{' '}
                <Form.Check.Label className="opacity-100" htmlFor="radio3">
                  Active - Disabled
                </Form.Check.Label>
              </Form.Group>{' '}
              <Form.Group className="radio d-inline-block me-2 form-group">
            ...
            <Card.Body>
              ...
              <div className="d-flex gap-2 flex-wrap">
                <Form.Group className="custom-control custom-radio custom-radio-color custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio01" name="customRadio-11" className="bg-primary me-1" />{' '}
                  <Form.Check.Label htmlFor="customRadio01"> Primary </Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-radio custom-radio-color custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio02" name="customRadio-11" className="bg-success me-1" />{' '}
                  <Form.Check.Label htmlFor="customRadio02"> Success </Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-radio custom-radio-color custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio03" name="customRadio-11" className="bg-danger me-1" />{' '}
                  <Form.Check.Label htmlFor="customRadio03"> Danger </Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-radio custom-radio-color custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio04" name="customRadio-11" className="bg-warning me-1" />{' '}
                  <Form.Check.Label htmlFor="customRadio04"> Warning </Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-radio custom-radio-color custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio05" name="customRadio-11" className="bg-dark me-1" />{' '}
                  <Form.Check.Label htmlFor="customRadio05"> Dark </Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-radio custom-radio-color custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio06" name="customRadio-11" className="bg-info me-1" />{' '}
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="d-flex gap-2 flex-wrap">
                ...
                <Form.Group className="custom-control custom-radio custom-control-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio10" name="customRadio-4" disabled defaultChecked />{' '}
            ...
            <Card.Body>
              ...
              <div className="d-flex gap-2 flex-wrap">
                <Form.Group className="form-check form-check-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio-1" name="customRadio-10" className="text-primary me-2" />{' '}
                  <Form.Check.Label htmlFor="customRadio-1"> Primary </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-check-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio-2" name="customRadio-10" className="text-success me-2" />{' '}
                  <Form.Check.Label htmlFor="customRadio-2"> Success </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-check-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio-3" name="customRadio-10" className="text-danger me-2" />{' '}
                  <Form.Check.Label htmlFor="customRadio-3"> Danger </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-check-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio-4" name="customRadio-10" className="text-warning me-2" />{' '}
                  <Form.Check.Label htmlFor="customRadio-4"> Warning </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-check-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio-5" name="customRadio-10" className="text-dark me-2" />{' '}
                  <Form.Check.Label htmlFor="customRadio-5"> Dark </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-check-inline form-group">
                  <Form.Check.Input type="radio" id="customRadio-6" name="customRadio-10" className="text-info me-2" />{' '}
