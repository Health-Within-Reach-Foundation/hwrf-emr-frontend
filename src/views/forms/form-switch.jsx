            ...
            <Card.Body className="pt-2">
              ...
              <div className="d-flex flex-wrap gap-4">
                <Form.Group className="form-check form-group form-switch">
                  ...
                  <Form.Check.Label className="form-check-label" htmlFor="flexSwitchCheckDefault">
                    false / Inactive
                  </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-switch form-group">
                  <Form.Check.Input
                    ...
                    defaultChecked
                  />
                  <Form.Check.Label className="form-check-label" htmlFor="flexSwitchCheckChecked">
                    true / active
                  </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-switch form-group">
                  <Form.Check.Input
                    ...
                    disabled
                  />
                  <Form.Check.Label className="form-check-label" htmlFor="flexSwitchCheckCheckedDisabled">
                    disable / active
                  </Form.Check.Label>
                </Form.Group>
                <Form.Group className="form-check form-switch form-group">
                  <Form.Check.Input
                    ...
                    disabled
                  />
                  <Form.Check.Label className="form-check-label" htmlFor="flexSwitchCheckDisabled">
                    disable / Inactive
                  </Form.Check.Label>
                </Form.Group>
              </div>
                ...
                <div className="d-flex flex-column align-items-center gap-1 form-group mb-0">
                  ...
                  <div>
                    ...
                    <label htmlFor="switch" className="toggles text-white bg-primary border-primary">
                      <p className="texts ps-1">On &nbsp;&nbsp;Off</p>
                    </label>
                  </div>
                </div>
                <div className="d-flex flex-column align-items-center gap-1 form-group mb-0">
                  ...
                  <div>
                    ...
                    <label htmlFor="tr_fal_switch" className="toggles text-white bg-success border-success">
                      <p className="texts ps-1">Tr &nbsp;&nbsp;&nbsp;&nbsp;fal</p>
                    </label>
                  </div>
                </div>
                <div className="d-flex flex-column align-items-center gap-1 form-group mb-0">
                  ...
                  <div>
                    ...
                    <label htmlFor="y_n_switch" className="toggles text-white bg-danger border-danger">
                      <p className="texts ps-1">Yes&nbsp;&nbsp;No</p>
                    </label>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <Card.Body className="pt-2">
              ...
              <div className="d-flex flex-wrap gap-4">
                <Form.Group className="form-check form-group form-switch">
                  <Form.Check.Input
                    className="form-check-input bg-primary border-0 text-primary"
                    type="checkbox"
                    role="switch"
                    id="flexSwitchCheckChecked"
                    defaultChecked
                ...
                <Form.Group className="form-check form-group form-switch">
                  <Form.Check.Input
                    className="form-check-input bg-success border-0 text-success"
                    type="checkbox"
                    role="switch"
                    id="flexSwitchCheckChecked"
                    defaultChecked
                ...
                <Form.Group className="form-check form-group form-switch">
                  <Form.Check.Input
                    className="form-check-input bg-danger border-0 text-danger"
                    type="checkbox"
                    role="switch"
                    id="flexSwitchCheckChecked"
                    defaultChecked
                ...
                <Form.Group className="form-check form-group form-switch">
                  <Form.Check.Input
                    className="form-check-input bg-warning border-0 text-warning"
                    type="checkbox"
                    role="switch"
                    id="flexSwitchCheckChecked"
                    defaultChecked
                ...
                <Form.Group className="form-check form-group form-switch">
                  <Form.Check.Input
                    className="form-check-input bg-gray border-0 text-gray"
                    type="checkbox"
                    role="switch"
                    id="flexSwitchCheckChecked"
                    defaultChecked
                  ...
                  <div>
                    ...
                    <label htmlFor="switchs" className="toggles text-white bg-primary border-primary">
                      <p className="texts ps-1">
                        <i className="fa fa-check custom-switch-size"></i> &nbsp;&nbsp;&nbsp;&nbsp;
                        <i className="fa fa-check custom-switch-size"></i>
                      </p>
                    </label>
                  </div>
                ...
                <div className="d-flex flex-column align-items-center gap-1 form-group mb-0">
                  ...
                  <div>
                    ...
                    <label htmlFor="dan-switch" className="toggles text-white bg-danger border-danger">
                      <p className="texts ps-1">
                        <i className="fa fa-times custom-switch-size"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <i className="fa fa-times custom-switch-size"></i>
                      </p>
                    </label>
                  </div>
                ...
                <div className="d-flex flex-column align-items-center gap-1 form-group mb-0">
                  ...
                  <div>
                    ...
                    <label htmlFor="war-switch" className="toggles text-white bg-warning border-warning">
                      <p className="texts ps-1">
                        <i className="fa fa-exclamation-triangle custom-switch-size"></i> &nbsp;&nbsp;&nbsp;&nbsp;
                        <i className="fa fa-exclamation-triangle custom-switch-size"></i>
                      </p>
                    </label>
                  </div>
                  ...
                  <div>
                    ...
                    <label htmlFor="dark-switch" className="toggles text-white bg-dark border-dark">
                      <p className="texts ps-2">
                        <i className="fa fa-thumb-tack custom-switch-size"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <i className="fa fa-thumb-tack custom-switch-size"></i>
                      </p>
                    </label>
                  </div>
                ...
                <div className="d-flex flex-column align-items-center gap-1 form-group mb-0">
                  ...
                  <div>
                    ...
                    <label htmlFor="info-switch" className="toggles text-white bg-info border-info">
                      <p className="texts ps-2">
                        <i className="fa fa-info custom-switch-size"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <i className="fa fa-info custom-switch-size"></i>
                      </p>
                    </label>
                  </div>
