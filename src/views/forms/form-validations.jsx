              ...
              <Form className="cust-form-elements">
                <Row>
                  <Col md="6" className="form-group">
                    <Form.Label md="6" className="mb-0" htmlFor="validationDefault01">
                      First name
                    </Form.Label>
                    <Form.Control type="text" id="validationDefault01" required />
                  </Col>
                  <Col md="6" className="form-group">
                    <Form.Label className="mb-0" htmlFor="validationDefault02">
                      Last name
                    </Form.Label>
                    <Form.Control type="text" id="validationDefault02" required />
                  </Col>
                  <Col md="6" className="form-group">
                    <Form.Label className="mb-0" htmlFor="validationCustomUsername">
                      Username
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group">
                    <Form.Label className="mb-0" htmlFor="validationDefault03">
                      City
                    </Form.Label>
                    <Form.Control type="text" id="validationDefault03" required />
                  </Col>
                  <Col md="6" className="form-group">
                    <Form.Label className="mb-0" htmlFor="validationDefault04">
                      State
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group">
                    <Form.Label className="mb-0" htmlFor="validationDefault05">
                      Zip
                    </Form.Label>
                ...
                <Form.Group className="form-group">
                  <Form.Check>
                    ...
                    <Form.Check.Label htmlFor="invalidCheck2">Agree to terms and conditions</Form.Check.Label>
                  </Form.Check>
                </Form.Group>
                <Form.Group className="form-group">
          ...
          <Card className="iq-supported-elements">
            ...
            <Card.Body>
              ...
              <Form className="was-validated cust-form-elements" validated>
                <Form.Group className="form-group">
                  <Form.Label htmlFor="validationTextarea" className="form-label mb-0">
                    Textarea
                  </Form.Label>
                  <Form.Control
                    as="textarea"
            ...
            <Card.Body>
              ...
              <Form noValidate validated={validated} onClick={handleSubmit} className="needs-validation cust-form-elements">
                <Row className="needs-validation">
                  <Col md="6" className="form-group">
                    <Form.Label htmlFor="validationCustom01" className="mb-0">
                      First name
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group">
                    <Form.Label htmlFor="validationCustom02" className="mb-0">
                      Last name
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group mt-0">
                    <Form.Label htmlFor="validationCustomUsername01" className="mb-0">
                      Username
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group mt-0">
                    <Form.Label htmlFor="validationCustom03" className="mb-0">
                      City
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group mt-0">
                    <Form.Label htmlFor="validationCustom04" className="mb-0">
                      State
                    </Form.Label>
                  ...
                  <Col md="6" className="form-group mt-0">
                    <Form.Label htmlFor="validationCustom05" className="mb-0">
                      Zip
                    </Form.Label>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Form
                ...
                className="needs-validation cust-form-elements"
                noValidate
              >
                <Row className="needs-validation">
                  <Col md="6" className="position-relative form-group">
                    <Form.Label htmlFor="validationTooltip01" className="mb-0">
                      First name
                    </Form.Label>
                  ...
                  <Col md="6" className="position-relative form-group">
                    <Form.Label htmlFor="validationTooltip02" className="mb-0">
                      Last name
                    </Form.Label>
                  ...
                  <Col md="6" className="position-relative form-group">
                    <Form.Label htmlFor="validationTooltipUsername" className="mb-0">
                      Username
                    </Form.Label>
                    <div className="input-group has-validation">
                  ...
                  <Col md="6" className="position-relative form-group">
                    <Form.Label htmlFor="validationTooltip03" className="mb-0">
                      City
                    </Form.Label>
                  ...
                  <Col md="6" className="position-relative form-group">
                    <Form.Label htmlFor="validationTooltip05" className="mb-0">
                      Zip
                    </Form.Label>
