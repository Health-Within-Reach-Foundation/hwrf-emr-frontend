            ...
            <Card.Body>
              ...
              <div className="d-flex gap-3 flex-wrap ">
                <Form.Group className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline p-0 form-group">
                  <Form.Check.Input type="checkbox" className="bg-primary me-1 border-0" id="customCheck-1" defaultChecked />{' '}
                ...
                <Form.Group className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline form-group">
                  <Form.Check.Input type="checkbox" className="bg-success me-1 border-0" id="customCheck-2" defaultChecked />{' '}
                  <Form.Check.Label htmlFor="customCheck-2">Success</Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline form-group">
                  <Form.Check.Input type="checkbox" className="bg-danger me-1 border-0" id="customCheck-3" defaultChecked />{' '}
                  <Form.Check.Label htmlFor="customCheck-3">Danger</Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline form-group">
                  <Form.Check.Input type="checkbox" className="bg-warning me-1 border-0" id="customCheck-4" defaultChecked />{' '}
                  <Form.Check.Label htmlFor="customCheck-4">Warning</Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline form-group">
                  <Form.Check.Input type="checkbox" className="bg-dark me-1 border-0" id="customCheck-5" defaultChecked />{' '}
                  <Form.Check.Label htmlFor="customCheck-5">Dark</Form.Check.Label>
                </Form.Group>
                <Form.Group className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline form-group">
                  <Form.Check.Input type="checkbox" className="bg-info me-1 border-0" id="customCheck-6" defaultChecked />{' '}
