...
const ConfirmPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      setLoading(true);
      const response = await authServices.resetPassword(token, formData.password);
  ...
  if (success) return <ConfirmEmail message={successMessage} />; // Show success component
      ...
      >
        <Row className="justify-content-center">
          <Col style={{}}>
            ...
            <div>
              <h4 className="text-center mb-1">Hi, {user?.name || 'User'}!</h4>
              <p className="text-center mb-1">Set your password to access your account.</p>
