          ...
          <Row>
            ...
            <Col md={6} className="position-relative z-2">
              <div className="sign-in-form d-flex flex-column justify-content-center">
                <img src={user1} alt="user-image" width="25%" className="rounded-circle" />
                <h4 className="mt-3 mb-0">Hi ! Michael Smith</h4>
                <p>Enter your password to access the admin.</p>
                <Form className="mt-0">
                  <Form.Group className="form-group mb-3" controlId="password">
                    <Form.Label className="mb-2">Password</Form.Label>
                    <Form.Control type="password" className="mb-0 border" placeholder="Password" />
                  </Form.Group>
                  <div className="d-inline-block w-100">
                    <button type="submit" className="btn btn-primary-subtle float-end mt-3">
                      Log In
                    </button>
                  </div>
                </Form>
