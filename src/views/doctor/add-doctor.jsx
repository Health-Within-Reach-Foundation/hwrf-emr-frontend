              ...
              <div className="new-user-info">
                <Form>
                  <Row className="cust-form-input">
                    ...
                    <Col md={6} className="form-group">
                      <Form.Label htmlFor="add2" className="mb-0">
                        Street Address 2:
                      </Form.Label>
                    ...
                    <Col md={6} className="form-group">
                      <Form.Label htmlFor="mobno" className="mb-0">
                        Mobile Number:
                      </Form.Label>
                      <Form.Control type="text" className="my-2" id="mobno" placeholder="Mobile Number" />
                    </Col>
                    <Col md={6} className="form-group">
                      <Form.Label htmlFor="altconno" className="mb-0">
                        Alternate Contact:
                      </Form.Label>
                      <Form.Control type="text" className="my-2" id="altconno" placeholder="Alternate Contact" />
                    </Col>
                    <Col md={6} className="form-group">
                    ...
                    <Col md={6} className="form-group">
                      <Form.Label htmlFor="pno" className="mb-0">
                        Pin Code:
                      </Form.Label>
