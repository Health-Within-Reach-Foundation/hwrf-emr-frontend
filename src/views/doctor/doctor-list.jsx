                ...
                <Card>
                  <Card.Body className="text-center">
                    <div className="doc-profile">
                      <img className="rounded-circle img-fluid avatar-80" src={doctor.img} alt="profile" />
                    </div>
                    ...
                    <div className="iq-doc-description mt-2">
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam auctor non erat non gravida. In id ipsum
                        consequat
                      </p>
                    </div>
                    ...
                    <Link to="/doctor/doctor-profile" className="btn btn-primary-subtle">
                      View Profile
                    </Link>
                  </Card.Body>
                </Card>
