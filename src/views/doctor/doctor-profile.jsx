...
const DoctorProfile = (props) => {
  ...
  return (
    <>
      <FsLightbox
        toggler={imageController.toggler}
        sources={[imgg1, imgg2, imgg3, imgg4, imgg5, imgg6, imgg7, imgg8, imgg9]}
          ...
          <Card>
            <Card.Body className="ps-0 pe-0 pt-0">
              <div className="docter-details-block">
                <div className="doc-profile-bg bg-primary rounded-top-2" style={{ height: '150px' }}></div>
                ...
                <div className="text-center mt-3 ps-3 pe-3">
                  ...
                  <p>Doctor</p>
                  <p className="mb-0">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus repudiandae eveniet harum.
                  </p>
                </div>
                <hr />
                    ...
                    <table className="table mb-0 table-borderless">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span className="badge text-bg-success">Distinction</span>
                          </td>
                        </tr>
                        <tr>
                          <td>2014</td>
                    ...
                    <table className="table mb-0 table-borderless">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Netherland Medical College</td>
                          <td>
                            <span className="badge text-bg-success">excellence</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
