              ...
              <Form id="form-wizard1" className="mt-3 text-center iq-form-wizard">
                <ul id="top-tab-list" className="p-0 row list-inline">
                  {tabs.map((tab, index) => (
                    <li
                      key={index}
                      className={`mb-2 col-lg-3 col-md-6 text-start ${isActive(index) ? 'active' : ''} ${isDone(index) ? 'active done' : ''}`}
                    >
                      <a href="#">
                        <div className="iq-icon me-3">{tab.icon}</div> <span className="dark-wizard">{tab.name}</span>
                      </a>
                    </li>
                  ))}
                </ul>
                ...
                {currentTab === 1 && (
                  <fieldset>
                    <div className="form-card text-start">
                      ...
                      <Button
                        variant="dark"
                        className="previous action-button-previous float-end me-1"
                        onClick={() => changeTab(-1)}
                  ...
                  <fieldset>
                    <div className="form-card text-start">
                      ...
                      <Row className="justify-content-center">
                        <Col xs={3}>
                          <img src={successImg} className="img-fluid" alt="fit-image" loading="lazy" />
                        </Col>
                      </Row>
                      <br />
                      <br />
