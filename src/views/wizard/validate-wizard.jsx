...
const ValidteWizard = () => {
  ...
  const tabTitles = [
    { tabName: 'User Detail', id: 'user-tab' },
    { tabName: 'Document Detail', id: 'document-tab' },
    { tabName: 'Bank Detail', id: 'bank-tab' },
    { tabName: 'Confirm', id: 'confirm-tab' },
  ];
  const iconClasses = [
              ...
              <Form className="form needs-validation iq-form-validate" noValidate onSubmit={handleSubmit}>
                ...
                <Row className="justify-content-between">
                  <Col xs="auto">
                    <Button
                      type="button"
                      className="btn btn-secondary-subtle border-secondary-subtle"
                      onClick={previous}
                      hidden={tabCurrentIndex === 1}
                    >
                      Previous
                    </Button>
                  </Col>
                  <Col xs="auto">
                    <Button
                      type="button"
                      className="btn btn-primary-subtle border-primary-subtle"
                      onClick={next}
                      hidden={tabCurrentIndex === tabCount}
                    >
                      Next
                    </Button>
                    <Button
