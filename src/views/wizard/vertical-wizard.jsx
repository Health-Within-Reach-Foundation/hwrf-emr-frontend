...
const VerticalWizard = () => {
  ...
  const tabs = [{ id: 'personal' }, { id: 'contact' }, { id: 'official' }, { id: 'payment' }];
              ...
              <Row>
                <Col md="3">
                  <ul id="top-tabbar-vertical" className="p-0">
                    <li
                      className={`active step1 list-group-item ${isActive(0) ? 'active' : ''} ${isDone(0) ? 'active' : ''}`}
                      id="personal"
                    >
                      <a href="#!">
                    ...
                    <li
                      className={`step2 list-group-item ${isActive(1) ? 'active' : ''} ${isDone(1) ? 'active' : ''}`}
                      id="contact"
                    >
                      <a href="#!">
                    ...
                    <li
                      className={`step3 list-group-item ${isActive(2) ? 'active' : ''} ${isDone(2) ? 'active' : ''}`}
                      id="official"
                    >
                      <a href="#!">
                    ...
                    <li
                      className={`step4 list-group-item ${isActive(3) ? 'active' : ''} ${isDone(3) ? 'active' : ''}`}
                      id="payment"
                    >
                      <a href="#!">
                  ...
                  <Form id="form-wizard3" className="text-start">
                    ...
                    {currentTab === 0 && (
                      <fieldset>
                              ...
                              <Form.Group className="form-group">
                                ...
                                <Form.Check className="p-0">
                                  <Form.Check className="form-check-inline">
                                    <Form.Check.Input type="radio" name="customRadio" id="customRadio1"></Form.Check.Input>
                                    <Form.Check.Label htmlFor="customRadio1">Male</Form.Check.Label>
                                  </Form.Check>{' '}
                                  <Form.Check className="form-check-inline">
                                    <Form.Check className="form-check-inline">
                                      <Form.Check.Input type="radio" name="customRadio" id="customRadio2"></Form.Check.Input>{' '}
                                      <Form.Check.Label htmlFor="customRadio2">Female</Form.Check.Label>
                                    </Form.Check>
                                  </Form.Check>
                                </Form.Check>
                              </Form.Group>
                        ...
                        <Button
                          type="button"
                          className="btn btn-primary-subtle border-primary-subtle next action-button float-end"
                          onClick={() => changeTab(1)}
                    ...
                    {currentTab === 3 && (
                      <fieldset>
                        <div className="form-card text-left">
                          ...
                          <Button
                            type="submit"
                            className="btn btn-primary-subtle border-primary-subtle action-button float-end"
