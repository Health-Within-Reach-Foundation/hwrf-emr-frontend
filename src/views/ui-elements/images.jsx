      ...
      <Row>
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              <p>
                Images in Bootstrap are made responsive with <code>.img-fluid</code>. <code>max-width: 100%;</code> and{' '}
                <code>height: auto;</code> are applied to the image so that it scales with the parent element.
              </p>
              <Image src={small1} className="img-fluid" alt="Responsive image" />
            </Card.Body>
          </Card>
          <Card>
            <Card.Header className="d-flex justify-content-between">
            ...
            <Card.Body>
              <p>
                ...
                <Link to="https://getbootstrap.com/docs/5.3/utilities/display/">responsive display utilities</Link>.
              </p>
              <div className="d-flex align-items-start">
                <Image src={pageimg15} className="img-fluid avatar-70 me-3" alt="#" />
              ...
              <div className="d-flex align-items-start mt-2">
                <div className="flex-shrink-0">
                  <Image src={pageimg16} className="img-fluid avatar-70 me-3" alt="#" />
                </div>
                <div className="flex-grow-1">
                  <h5 className="mt-0">Media heading</h5>
                  Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                Change the order of content in media objects by modifying the HTML itself, or by adding some custom flexbox
                CSS to set the <code>order</code> property (to an integer of your choosing).
              </p>
              <div className="d-flex align-items-center mb-5">
                ...
                <Image src={pageimg18} className="ms-3 img-fluid avatar-70" alt="#" />
              </div>
              <div className="d-flex align-items-center mb-5">
                <div>
                ...
                <Image src={pageimg19} className="align-self-center ms-3 img-fluid avatar-70" alt="#" />
              </div>
              <div className="d-flex align-items-center">
                ...
                <Image src={pageimg20} className="align-self-end ms-3 img-fluid avatar-70" alt="#" />
              </div>
            </Card.Body>
          </Card>
        </Col>
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              <p>
                In addition to our{' '}
                <Link to="https://getbootstrap.com/docs/5.3/utilities/borders/">border-radius utilities</Link>, you can use{' '}
                <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.
              </p>
              <Image src={pageimg10} className="img-thumbnail" alt="Responsive image" />{' '}
              <Image src={pageimg11} className="rounded ms-3" alt="Responsive image" />{' '}
              <Image src={pageimg12} className="rounded-circle ms-3" alt="Responsive image" />{' '}
            </Card.Body>
          </Card>
          <Card>
            <Card.Header className="d-flex justify-content-between">
            ...
            <Card.Body>
              ...
              <div className="d-flex justify-content-between">
                <Image src={pageimg13} className="mt-2 img-fluid rounded" alt="Responsive image" />
                <Image src={pageimg14} className="mt-2 img-fluid rounded float-right" alt="Responsive image" />
              </div>
            </Card.Body>
          </Card>
          <Card>
            ...
            <Card.Body>
              ...
              <div className="d-flex align-items-center mb-4">
                <Image src={pageimg21} className="align-self-start me-3 img-fluid avatar-70" alt="#" />
                <div>
              ...
              <div className="d-flex align-items-center mb-4">
                <Image src={pageimg22} className="align-self-center me-3 img-fluid avatar-70" alt="#" />
                <div>
              ...
              <div className="d-flex align-items-center">
                <Image src={pageimg23} className="align-self-end me-3 img-fluid avatar-70" alt="#" />
                <div>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                Because the media object has so few structural requirements, you can also use these classes on list HTML
              ...
              <ul className="list-unstyled">
                <li className="d-flex">
                  <Image src={pageimg24} className="me-3 img-fluid avatar-70" alt="#" />
                  <div>
                ...
                <li className="d-flex my-4">
                  <Image src={pageimg15} className="me-3 img-fluid avatar-70" alt="#" />
                  <div>
                    <h5 className="mt-0 mb-1">List-based media object</h5>
                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus
                    odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate
                ...
                <li className="d-flex">
                  <Image src={pageimg16} className="me-3 img-fluid avatar-70" alt="#" />
                  <div>
                    <h5 className="mt-0 mb-1">List-based media object</h5>
                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus
                    odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate
