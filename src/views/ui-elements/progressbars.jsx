          ...
          <Card>
            ...
            <Card.Body>
              ...
              <ul>
                ...
                <li>
                  The <code>.progress-bar</code> requires an inline style, utility class, or custom CSS to set their width.
                </li>
                <li>
                  The <code>.progress-bar</code> also requires some <code>role</code> and <code>aria</code> attributes to
                  make it accessible.
                </li>
              </ul>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="progress mb-3" style={{ height: '10px' }}>
                <ProgressBar
                  className="custom-progress-bars"
                  variant="primary"
                  style={{ width: '25%' }}
                  now={100}
                  label={'25%'}
        ...
        <Col sm="12" lg="6">
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="progress mb-3">
                <ProgressBar className="custom-progress-bars" striped style={{ width: '10%' }} now={100}></ProgressBar>
              </div>
              <div className="progress mb-3">
                <ProgressBar
                  className="custom-progress-bars"
