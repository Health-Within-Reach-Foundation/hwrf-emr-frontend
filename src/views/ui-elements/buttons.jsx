        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <button className="btn btn-gray-subtle mb-3">Light</button>{' '}
        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="info-subtle" className="btn mb-3">
                <i className="ri-heart-fill"></i>
                Info
              </Button>{' '}
        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary" className="rounded-pill btn mb-3">
                <i className="ri-bill-fill"></i>
                Primary
              </Button>{' '}
              <Button variant="secondary" className="rounded-pill btn mb-3">
                <i className="ri-heart-fill"></i>
                Secondary
              </Button>{' '}
              <Button variant="success-subtle" className="rounded-pill btn mb-3">
                <i className="ri-bill-fill"></i>
                Success
              </Button>{' '}
              <Button variant="danger-subtle" className="rounded-pill btn mb-3">
                <i className="ri-heart-fill"></i>
                Danger
              </Button>{' '}
              <Button variant="warning-subtle" className="rounded-pill btn mb-3">
                <i className="ri-bill-fill"></i>
                Warning
              </Button>{' '}
              <Button variant="info-subtle" className="rounded-pill btn mb-3">
                <i className="ri-heart-fill"></i>
                Info
              </Button>{' '}
              <Button variant="gray-subtle" className="rounded-pill btn mb-3">
                <i className="ri-bill-fill"></i>
                Light
              </Button>{' '}
              <Button variant="dark-subtle" className="rounded-pill btn mb-3">
                <i className="ri-heart-fill"></i>
                Dark
              </Button>{' '}
              <Button variant="link" className="rounded-pill btn mb-3">
                <i className="ri-bill-fill"></i>
                Link
              </Button>{' '}
            </Card.Body>
        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="danger-subtle" className="mb-3 mb-md-0" type="button" defaultValue="Input">
                Input{' '}
              </Button>{' '}
              <Button variant="warning-subtle" type="submit" defaultValue="Submit">
                Submit{' '}
              </Button>{' '}
              <Button variant="primary-subtle" type="reset" defaultValue="Reset">
                Reset{' '}
              </Button>
            </Card.Body>
          </Card>
        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="" className="btn-md btn-link-subtle mb-3">
                <i class="ri-moon-fill pe-0"></i>
              </Button>
        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary-subtle">Single toggle</Button>{' '}
            </Card.Body>
          </Card>
        </Col>
      </Row>
        ...
        <Col sm="12" lg="6">
          ...
          <Card>
            ...
            <CardBody className="ui-button-group">
              ...
              <div className="d-block">
                <div className="btn-group mt-3 btn-group-medium" role="group" aria-label="Basic example">
              ...
              <div className="d-block">
                <div className="btn-group btn-group-sm mt-3" role="group" aria-label="Basic example">
                  <Button variant="primary-subtle" type="button">
                    Left
                  </Button>
                  <Button variant="primary-subtle" type="button">
        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <div className="btn-group btn-group-medium" role="group" aria-label="Basic example">
                <Button variant="primary-subtle" type="button">
                  Left
                </Button>
                <Button variant="primary-subtle" type="button">
              ...
              <div className="btn-toolbar mt-3" role="toolbar" aria-label="Toolbar with button groups">
                <div className="btn-group me-2" role="group" aria-label="First group">
                  <Button variant="secondary-subtle" className="mb-2 mb-md-0">
                    1
                  </Button>
                  <Button variant="secondary-subtle" className="mb-2 mb-md-0">
                    2
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="btn-group btn-group-medium" role="group" aria-label="Button group with nested dropdown">
