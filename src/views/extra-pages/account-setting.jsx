                ...
                <Form>
                  ...
                  <Form.Group className="form-group">
                    ...
                    <div className="custom-control custom-checkbox custom-control-inline">
                      ...
                      <Form.Check.Label className="custom-control-label" htmlFor="english">
                        English
                      </Form.Check.Label>
                    </div>
                    <div className="custom-control custom-checkbox custom-control-inline">
                      <input type="checkbox" className="custom-control-input" id="french" defaultChecked />{' '}
                      <Form.Check.Label className="custom-control-label" htmlFor="french">
                        French
                      </Form.Check.Label>
                    </div>
                    <div className="custom-control custom-checkbox custom-control-inline">
                      <input type="checkbox" className="custom-control-input" id="hindi" />{' '}
                      <Form.Check.Label className="custom-control-label" htmlFor="hindi">
                        Hindi
                      </Form.Check.Label>
                    </div>
                    <div className="custom-control custom-checkbox custom-control-inline">
                      <input type="checkbox" className="custom-control-input" id="spanish" defaultChecked />{' '}
                      <Form.Check.Label className="custom-control-label" htmlFor="spanish">
                        Spanish
                      </Form.Check.Label>
                    </div>
                    <div className="custom-control custom-checkbox custom-control-inline">
                      <input type="checkbox" className="custom-control-input" id="arabic" />{' '}
                      <Form.Check.Label className="custom-control-label" htmlFor="arabic">
                        Arabic
                      </Form.Check.Label>
                    </div>
                    <div className="custom-control custom-checkbox custom-control-inline">
                      <input type="checkbox" className="custom-control-input" id="italian" />{' '}
                      <Form.Check.Label className="custom-control-label" htmlFor="italian">
                        Italian
                      </Form.Check.Label>
                    </div>
                  </Form.Group>
