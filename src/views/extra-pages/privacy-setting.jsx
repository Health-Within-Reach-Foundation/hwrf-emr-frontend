              ...
              <div className="acc-privacy">
                <div className="data-privacy">
                  ...
                  <Form.Check>
                    ...
                    <Form.Check.Label className="ps-2" for="customCheck5">
                      Private Account
                    </Form.Check.Label>
                  </Form.Check>
                  <p>
                ...
                <div className="data-privacy">
                  ...
                  <Form.Check>
                    ...
                    <Form.Check.Label className="ps-2" for="activety">
                ...
                <div className="data-privacy">
                  ...
                  <Form.Check>
                    ...
                    <Form.Check.Label className="ps-2" for="story">
                      Allow Sharing
                    </Form.Check.Label>
                  </Form.Check>
                  <p>
                ...
                <div className="data-privacy">
                  ...
                  <Form.Check>
                    ...
                    <Form.Check.Label for="automatically" className="ps-2">
                      Add Automatically
                    </Form.Check.Label>
                  </Form.Check>
                  <Form.Check>
                    <Form.Check.Input type="radio" name="customRadio0" id="manualy" />{' '}
                    <Form.Check.Label for="manualy" className="ps-2">
                      Add Manualy
                    </Form.Check.Label>
                  </Form.Check>
                  <p>
                ...
                <div className="data-privacy">
                  ...
                  <Form.Check>
                    ...
                    <Form.Check.Label for="public" className="ps-2">
                      Public
                    </Form.Check.Label>
                  </Form.Check>
                  <Form.Check>
                    <Form.Check.Input type="radio" name="customRadio1" id="friend" />{' '}
                    <Form.Check.Label for="friend" className="ps-2">
                      Friend
                    </Form.Check.Label>
                  </Form.Check>
                  <Form.Check>
                    <Form.Check.Input type="radio" name="customRadio1" id="spfriend" />{' '}
                    <Form.Check.Label for="spfriend" className="ps-2">
                      Specific Friend
                    </Form.Check.Label>
                  </Form.Check>
                  <Form.Check>
                    <Form.Check.Input type="radio" name="customRadio1" id="onlyme" />{' '}
                    <Form.Check.Label for="onlyme" className="ps-2">
                      Only Me
                    </Form.Check.Label>
                  </Form.Check>
                  <p>
                ...
                <div className="data-privacy">
                  ...
                  <Form.Check>
                    ...
                    <Form.Check.Label for="enable" className="ps-2">
                      Enable
                    </Form.Check.Label>
                  </Form.Check>
                  <Form.Check>
                    <Form.Check.Input type="radio" name="customRadio2" id="disable" />{' '}
                    <Form.Check.Label for="disable" className="ps-2">
                      Disable
                    </Form.Check.Label>
                  </Form.Check>
                  <p>
                ...
                <div className="data-privacy">
                  ...
                  <a href="#">
                    <i className="ri-customer-service-2-line me-2"></i>Support
                  </a>
                </div>
              </div>
            </Card.Body>
