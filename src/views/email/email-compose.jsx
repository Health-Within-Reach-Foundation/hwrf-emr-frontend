              ...
              <Card>
                <Card.Body>
                  ...
                  <form className="email-form">
                    ...
                    <Row className="form-group">
                      <Col sm={2}>
                        <label htmlFor="cc" className="col-form-label">
                          Cc:
                        </label>
                      </Col>
                      <Col sm={10} className="mb-3">
                      ...
                      <Col sm={10} className="mb-3">
                        <div className="form-floating">
                          <textarea
                            ...
                            style={{ height: '100px' }}
                          ></textarea>
                          <label className="iq-active" htmlFor="floatingTextarea2">
                            Comments
                          </label>
                        </div>
                      </Col>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                      <div className="d-flex flex-grow-1 align-items-center gap-2">
                        ...
                        <div className="send-panel d-flex align-items-center flex-wrap gap-2">
                          <label className="mb-0 bg-primary-subtle " htmlFor="file">
                            {' '}
                          ...
                          <label className="mb-0 bg-primary-subtle ">
                            {' '}
                            <Link to="#">
                      ...
                      <div className="d-flex align-items-center">
                        <div className="send-panel float-end">
                          ...
                          <label className="ms-2 mb-0 bg-primary-subtle ">
                            <Link to="#">
                              {' '}
