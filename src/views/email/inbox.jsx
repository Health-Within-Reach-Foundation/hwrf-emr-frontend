              ...
              <Card.Body>
                <div>
                  <div className="iq-email-list">
                    <button
                      className="btn btn-primary-subtle btn-lg btn-block mb-3 font-size-16 p-3 w-100"
                    ...
                    <Nav variant="pills" className="iq-email-ui flex-column " role="tablist">
                      <Nav.Link as="li" role="tab" data-bs-toggle="pill" eventKey="mail-inbox" aria-selected="true">
                        <Link to="/email/inbox">
                          <i className="ri-mail-line"></i>Inbox<span className="badge bg-primary ms-2">4</span>
                        </Link>
                      </Nav.Link>
                      <Nav.Link
                        as="li"
                    ...
                    <ul className="iq-email-ui iq-email-label list-unstyled">
                      <li>
                        <Link to="">
                          <i className="ri-focus-fill text-primary"></i>Personal
                        </Link>
                      </li>
                      <li>
                        <Link to="">
                      ...
                      <li>
                        <Link to="">
                          <i className="ri-focus-fill text-success"></i>Important
                        </Link>
                      </li>
                      <li>
                        <Link to="">
                      ...
                      <li>
                        <Link to="">
                          <i className="ri-focus-fill text-warning"></i>Private
                        </Link>
                      </li>
                      <li>
                        <Link to="">
                  ...
                  <div className="iq-email-to-list p-3">
                    <div className="iq-email-to-list-detail d-flex justify-content-between gap-3">
                      <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0 flex-shrink-0">
                        ...
                        <OverlayTrigger key={'Reload'} placement={'top'} overlay={<Tooltip id="Reload">Reload</Tooltip>}>
                          <li className="me-1">
                            <Link to="">
                        ...
                        <OverlayTrigger key={'Archive'} placement={'top'} overlay={<Tooltip id="Archive">Archive</Tooltip>}>
                          <li className="me-1">
                            <Link to="">
                        ...
                        <OverlayTrigger key={'Spam'} placement={'top'} overlay={<Tooltip id="Spam">Spam</Tooltip>}>
                          <li
                            className="me-1"
                        ...
                        <OverlayTrigger key={'Inbox'} placement={'top'} overlay={<Tooltip id="Inbox">Inbox</Tooltip>}>
                          <li className="me-1">
                            <Link to="">
                        ...
                        <OverlayTrigger key={'Zoom'} placement={'top'} overlay={<Tooltip id="Zoom">Zoom</Tooltip>}>
                          <li className="me-1">
                            <Link to="">
                      ...
                      <div className="iq-email-search d-flex flex-shrink-0">
                        ...
                        <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                          <li className="me-3">
                            <Dropdown
                              as="a"
                              className="font-size-14 d-flex gap-1"
                              href="#"
                              id="navbarDropdown"
                          ...
                          <OverlayTrigger key={'Next'} placement={'top'} overlay={<Tooltip id="Next">Next</Tooltip>}>
                            <li className="me-2">
                              <Link to="">
                          ...
                          <OverlayTrigger
                            key={'Setting'}
                            placement={'top'}
                            overlay={<Tooltip id="Setting">Setting</Tooltip>}
                          >
                            <li className="me-0">
                              <Link to="">
                        ...
                        <ul className="iq-email-sender-list iq-height">
                            ...
                            >
                              ...
                              <div className="iq-email-content">
                                <Link to="" className="iq-email-subject">
                                  Mackenzie Bnio (@MackenzieBnio) has sent you a direct message on Twitter! &nbsp;–&nbsp;
                          ...
                          <li>
                            ...
                            >
                              ...
                              <div className="iq-email-content">
                                <Link to="" className="iq-email-subject">
                                  Let Hunre (@lethunre) has sent you a direct message on Twitter! &nbsp;–&nbsp;
                                  <span> @LucasKriebel - Very cool :) Nicklas, You have a new direct message.</span>
                                </Link>
                                <div className="iq-email-date">11:49 am</div>
                              </div>
                          ...
                          <li className="iq-unread">
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk017" />
                              ...
                              <div className="iq-email-content">
                                <Link to="" className="iq-email-subject">
                                  Eb Begg (@ebbegg) has sent you a direct message on Twitter! &nbsp;–&nbsp;
                                  <span> @LucasKriebel - Very cool :) Nicklas, You have a new direct message.</span>
                                </Link>
                                <div className="iq-email-date">11:49 am</div>
                              </div>
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk011" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk11" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk12" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk13" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk14" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk15" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk16" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk17" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk02" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk03" />
                          ...
                          <li>
                            ...
                            >
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk04" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk018" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk004" />
                          ...
                          <li className="iq-unread">
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk012" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk024" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk09" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk013" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk014" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk019" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk025" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk015" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk020" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk026" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk027" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk032" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk037" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk028" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk033" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk038" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk029" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk034" />
                          ...
                          <li className="iq-unread">
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk035" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk009" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk010" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk016" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk021" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk023" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk030" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk031" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk036" />
                          ...
                          <li>
                            <div className="d-flex align-self-center iq-unread-inner">
                              <div className="iq-email-sender-info">
                                <div className="iq-checkbox-mail">
                                  <Form.Check>
                                    <Form.Check.Input type="checkbox" id="mailk040" />
