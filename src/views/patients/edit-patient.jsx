                  ...
                  <Card>
                    ...
                    <Card.Body>
                      <Form>
                          ...
                          <Col sm={12} className="form-group">
                            ...
                            <div className="form-floating overflow-hidden">
                              ...
                              <Form.Label htmlFor="floatingTextarea2">
                                37 Cardinal Lane Petersburg, VA 23803 United
                                States of America Zip Code: 85001
                              </Form.Label>
                            </div>
                          </Col>
                        </Row>
                        <Button
                          type="button"
                          className="btn btn-danger-subtle border-danger-subtle mt-3"
                        >
                          Cancel
                        </Button>{" "}
                        <Button
                          type="button"
                          className="btn btn-primary-subtle border-primary-subtle me-2 mt-3"
                        >
                          Submit
                        </Button>
                      </Form>
                  ...
                  <Card>
                    ...
                    <Card.Body className="cust-form-input">
                      <Form>
                        ...
                        <Button
                          type="reset"
                          className="btn btn-danger-subtle  border-danger-subtle"
                        >
                          Cancel
                        </Button>{" "}
                        <Button
                          type="submit"
                          className="btn btn-primary-subtle me-2  border-primary-subtle"
                        >
                          Submit
                        </Button>
                      </Form>
