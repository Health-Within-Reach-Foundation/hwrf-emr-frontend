                    ...
                    <Card.Body>
                      <Form>
                        ...
                        <Row className="cust-form-input">
                          ...
                          <Col sm={6} className="form-group">
                            <Form.Label htmlFor="uname" className="mb-0">
                              User Name:
                            </Form.Label>
                            <Form.Control type="text" className="my-2" id="uname" defaultValue="Bini@01" />
                          </Col>
                          <Col sm={6} className="form-group">
                            <Form.Label htmlFor="cname" className="mb-0">
                              City:
                            </Form.Label>
                        ...
                        <Button type="button" className="btn btn-danger-subtle border-danger-subtle mt-3">
                          Cancel
                        </Button>{' '}
                        <Button type="button" className="btn btn-primary-subtle border-primary-subtle me-2 mt-3">
                          Submit
                        </Button>
                      </Form>
                    </Card.Body>
                    ...
                    <Card.Body className="cust-form-input">
                      <Form>
                        <Form.Group className="form-group">
                          <Form.Label htmlFor="cpass" className="mb-0">
                            Current Password:
                          </Form.Label>
                        ...
                        <Form.Group className="form-group">
                          <Form.Label htmlFor="npass" className="mb-0">
                            New Password:
                          </Form.Label>
                          <Form.Control type="password" className="form-control my-2" id="npass" />
                        </Form.Group>
                        <Form.Group className="form-group">
                          <Form.Label htmlFor="vpass" className="mb-0">
                            Verify Password:
                          </Form.Label>
                          <Form.Control type="password" className="form-control my-2" id="vpass" />
                        </Form.Group>
                        <Button type="reset" className="btn btn-danger-subtle  border-danger-subtle">
                          Cancel
                        </Button>{' '}
                        <Button type="submit" className="btn btn-primary-subtle me-2  border-primary-subtle">
                          Submit
                        </Button>
                      </Form>
                    </Card.Body>
                      ...
                      <Form>
                        <Form.Group className="form-group">
                          <Row className="align-items-center">
                            <Col md={3}>
                              <Form.Label htmlFor="emailnotification" className="mb-0">
                                Email Notification:
                              </Form.Label>
                            </Col>
                            <Col md={9}>
                        ...
                        <Form.Group className="form-group">
                          <Row className="align-items-center">
                            <Col md={3}>
                              <Form.Label htmlFor="smsnotification" className="mb-0">
                                SMS Notification:
                              </Form.Label>
                            </Col>
                            <Col md={9}>
                          ...
                          <Row className="align-items-center">
                            ...
                            <Col md={9} className="col-md-9">
                              <div className="custom-control custom-checkbox">
                                ...
                                <Form.Check.Label className="custom-control-label" htmlFor="email01">
                ...
                <Tab.Pane className="fade" eventKey="manage-contact">
                  <Card>
                    ...
                    <div className="card-body cust-form-input">
                      <Form>
                        <Form.Group className="form-group">
                          <Form.Label htmlFor="cno" className="mb-0">
                            Contact Number:
                          </Form.Label>
