            ...
            <div className="new-user-info">
              ...
              >
                <Row gutter={16}>
                  ...
                  <Col md={12}>
                    <Form.Item label="Last Name" name="lname" rules={[{ required: true, message: 'Last name is required' }]}>
                  ...
                  <Col md={12}>
                    <Form.Item label="Address" name="add1" rules={[{ required: true, message: 'Address is required' }]}>
                      <Input placeholder="Street Address 1" disabled={loading} />
                    </Form.Item>
                  </Col>
                  <Col md={12}>
                    <Form.Item label="Town/City" name="city" rules={[{ required: true, message: 'City is required' }]}>
                  ...
                  <Col md={12}>
                    <Form.Item
                      ...
                      rules={[{ required: true, message: 'Referral source is required' }]}
                    >
                      <Select
                        ...
                        popupRender={(menu) => (
                          <>
                            ...
                            <Space style={{ padding: '0 8px 4px' }}>
                              ...
                              />
                              <Button type="text" icon={<PlusOutlined />} onClick={addReferralSource}>
                                Add
                              </Button>
                            </Space>
                          </>
                ...
                <div className="d-flex justify-content-end gap-2">
                  ...
                  <Button type="primary" htmlType="submit" loading={loading} className="px-5">
                    Save
                    <RiSave3Line />
                  </Button>
                </div>
