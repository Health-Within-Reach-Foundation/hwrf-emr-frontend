    ...
    <>
          ...
          <Card>
            ...
            <Card.Body>
              <ul className="list-unstyled m-0 p-0 job-classification">
                <li className="iq-check">
                  <i className="ri-check-line bg-danger me-2  text-white"></i>Meeting
                </li>
                <li className="iq-check">
                  <i className="ri-check-line bg-success me-2  text-white"></i>Business travel
                </li>
                <li className="iq-check">
                  <i className="ri-check-line bg-warning me-2  text-white"></i>Personal Work
                </li>
                <li className="iq-check">
                  <i className="ri-check-line bg-info me-2  text-white"></i>Team Project
                </li>
              </ul>
            </Card.Body>
          </Card>
              ...
              <ul className="m-0 p-0 today-schedule">
                <li className="d-flex">
                  <div className="schedule-icon">
                    <i className="ri-checkbox-blank-circle-fill text-primary me-2"></i>
                  </div>
                ...
                <li className="d-flex">
                  <div className="schedule-icon">
                    <i className="ri-checkbox-blank-circle-fill text-success me-2"></i>
                  </div>
                  <div className="schedule-text">
                    {' '}
          ...
          <Card>
            <Card.Header className="d-flex justify-content-between">
              ...
              <div className="card-action mt-2 mt-sm-0">
                <Button
                  type="button"
                  className="btn btn-primary-subtle ms-2 border-primary-subtle"
            ...
            <Card.Body className="fc-unthemed">
              <FullCalendar
                ...
                plugins={[timeGridPlugin, dayGridPlugin, interactionPlugin, listPlugin, bootstrapPlugin]}
      ...
      <Modal className="fade" show={show} onHide={modelClose} id="new-event">
        <Modal.Dialog className="m-0 iq-calender-model">
          {/* <Modal.Content > */}
          <Modal.Header>
            <Modal.Title as="h5" id="new-event-label">
              Add a events
            </Modal.Title>
            <button
              type="button"
            ...
            <Form>
              <div className="d-flex flex-column align-items-start">
                ...
                <TabContainer defaultActiveKey={'v-pills-home'}>
                  ...
                  >
                    <Nav.Item>
                      <Nav.Link as="button" className="btn btn-primary" eventKey="v-pills-home" type="button">
                        Event
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link as="button" className="btn btn-primary" eventKey="v-pills-profile" type="button">
                        Task
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link as="button" className="btn btn-primary" eventKey="v-pills-messages" type="button">
                        Reminder
                      </Nav.Link>
                    </Nav.Item>
                  </Nav>
          ...
          <Modal.Footer className="border-0">
            <Button type="button" className="btn btn-danger-subtle border-danger-subtle" onClick={() => modelClose()}>
              Discard Changes
            </Button>
            <Button type="button" className="btn btn-primary-subtle border-primary-subtle">
              Save
            </Button>
          </Modal.Footer>
          {/* </Modal.Content> */}
