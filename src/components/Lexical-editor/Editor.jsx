...
export default function Editor({
  ...
  return (
    <>
      {editable ? <ToolbarPlugin setIsLinkEditMode={setIsLinkEditMode} optionalToolbar={optionalToolbar} /> : null}
          ...
          contentEditable={
            <div className="editor-scroller">
              <div className="editor" ref={onRef}>
                <ContentEditable placeholder={placeholder} onKeyPress={onKeyPress} />
              </div>
            </div>
          }
