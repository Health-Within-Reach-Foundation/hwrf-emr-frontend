              ...
              <div className="iq-email-to-list p-3">
                <div className="d-flex justify-content-between">
                  <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                    ...
                    <OverlayTrigger key={'Mail'} placement={'top'} overlay={<Tooltip id="Mail">Mail</Tooltip>}>
                    ...
                    <OverlayTrigger key={'Info'} placement={'top'} overlay={<Tooltip id="Info">Info</Tooltip>}>
                      <li
                        className="me-2"
                    ...
                    <OverlayTrigger key={'Unread'} placement={'top'} overlay={<Tooltip id="Unread">Unread</Tooltip>}>
                      <li className="me-2">
                        <Link to="#">
                    ...
                    <OverlayTrigger key={'Transfer'} placement={'top'} overlay={<Tooltip id="Transfer">Transfer</Tooltip>}>
                      <li className="me-2">
                        <Link to="#">
                    ...
                    <OverlayTrigger key={'Bookmark'} placement={'top'} overlay={<Tooltip id="Bookmark">Bookmark</Tooltip>}>
                      <li className="me-2">
                        <Link to="#">
                  ...
                  <div className="iq-email-search d-flex">
                    <ul className="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                      <li className="me-3">
                        <a className="font-size-14" href="#">
                          1 of 505
                        </a>
                      </li>
                      <OverlayTrigger key={'Previous'} placement={'top'} overlay={<Tooltip id="Previous">Previous</Tooltip>}>
                        <li className="me-2">
                          <a href="#">
