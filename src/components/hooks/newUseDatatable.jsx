...
const newUseDataTable = ({
  ...
  lengthMenu = [10, 25, 50, 100], // Default entries per page options
}) => {
  useEffect(() => {
    setTimeout(() => {
      let datatableObj = {
        ...
        columns: columns,
        destroy: true,
        pageLength: pageLength, // Set default entries per page
        lengthMenu: lengthMenu, // Set entries per page options
        columnDefs: [
          {
            targets: columns
