...
const ChatData = (props) => {
  ...
  const { title, userimg, userdetailname, useraddress, usersortname, usertelnumber, userdob, usergender, userlanguage } =
    props.data;
    ...
    <>
              ...
              <Dropdown>
                ...
                <DropdownMenu className="dropdown-menu-right" aria-labelledby="dropdownMenuButton02">
                  <DropdownItem as="a" href="#">
                    <i className="fa fa-thumb-tack" aria-hidden="true"></i> Pin to top
                  </DropdownItem>
                  <DropdownItem as="a" href="#">
                    <i className="fa fa-trash-o" aria-hidden="true"></i> Delete chat
                  </DropdownItem>
                  <DropdownItem as="a" href="#">
      ...
      <div className="chat-content scroller">
        ...
        <div className="chat">
          ...
          <div className="chat-detail">
            <div className="chat-message">
              <p>Absolutely!</p>
              <p>HWRF Dashboard is the responsive bootstrap 5 admin template.</p>
            </div>
          </div>
        </div>
        <div className="chat chat-left">
      ...
      <div className="chat-footer p-3">
        <Form className="d-flex align-items-center">
          ...
          />
          <button type="submit" className="btn btn-primary-subtle d-flex align-items-center p-2">
