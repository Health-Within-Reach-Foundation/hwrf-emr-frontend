...
export const DefaultRoute = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: (
          <ClinicRouteGuard requiredPermissions={['administration:read', 'administration:write']}>
            <AllUsers />
          </ClinicRouteGuard>
        ),
      },
      ...
      },
      {
        ...
        // element: <PatientList />,
        element: (
          <ClinicRouteGuard requiredPermissions={['patients:write', 'patients:read']}>
            <PatientList />
          </ClinicRouteGuard>
        ),
      },
      ...
      // },
      {
        ...
        // element: <Appointment />,
        element: (
          <ClinicRouteGuard requiredPermissions={['queues:write', 'queues:read']}>
            <Appointment />
          </ClinicRouteGuard>
        ),
      },
      {
        ...
        // element: <Appointment />,
        element: (
          <ClinicRouteGuard requiredPermissions={['administration:finance']}>
            <Finance />
          </ClinicRouteGuard>
        ),
      },
